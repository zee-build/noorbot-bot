...
from utils.prayer_times import (
    ...
    PRAYER_KEYS, PRAYER_EMOJIS, PRAYER_NAMES, fmt12
)
    ...
    for user in users:
        ...
        try:
            ...
            await bot.send_message(
                ...
                text=(
                    f"🌙 *Suhoor Time!*\n\n"
                    f"Fajr is at *{fmt12(fajr_time)}* — eat & drink before then.\n\n"
    ...
    for user in users:
        ...
        try:
            ...
            await bot.send_message(
                chat_id=user["user_id"],
                text=(
                    f"🌅 *Iftar soon — Maghrib at {fmt12(maghrib_time)}!*\n\n"
